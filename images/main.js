const panorama = new PANOLENS.ImagePanorama("images/360foto2.jpg");
const panorama2 = new PANOLENS.ImagePanorama("images/360foto.jpg");
const imageContainer = document.querySelector(".image-container");

 var infospotPositions = [
    new THREE.Vector3(-5000, -500, 2700),
    new THREE.Vector3(-3300, 0, 4000)
/* distancia, altura, distancia + tamanho da seta */
